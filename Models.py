...
class FlippedAudioCNN(Module):
    def __init__(self): # in size: 162
        super(FlippedAudioCNN, self).__init__()
        
        self.conv1 = Sequential(
            Conv1d(1, 512, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(512),
            GELU(),
            Conv1d(512, 512, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(512),
        ...
        self.conv2 = Sequential(
            Conv1d(512, 256, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(256),
            GELU(),
            Conv1d(256, 256, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(256),
        ...
        self.conv3 = Sequential(
            Conv1d(256, 128, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(128),
            GELU(),
            Conv1d(128, 128, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(128),
        ...
        self.conv4 = Sequential(
            Conv1d(128, 64, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(64),
            GELU(),
            Conv1d(64, 64, kernel_size=3, stride=1, padding='same'),
            BatchNorm1d(64),
